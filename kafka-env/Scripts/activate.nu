...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\jhon_\Projects\kafka-cluster\kafka-env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\jhon_\Projects\kafka-cluster\kafka-env\Scripts\deactivate.nu'
